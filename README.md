# FraudShield
FraudShield is a machine learning-based web application that predicts whether an insurance claim is fraudulent or genuine. It analyzes customer and claim details using trained ML models to help insurers reduce fraud, save costs and improve decision-making. 
